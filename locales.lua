...
function LocalesModel:Create()
    return {
        ...
        ["en"] = {
            -- general
            ["AddonLoaded"] = "v" .. addon.version .. " maintained by Okara@Nightslayer. Use |cffDA8CFF/pm help|r for more informations.",
        ...
        ["ruRU"] = {
            ...
            ["VersionOutdated"] = "Ваша версия устарела. Последнюю версию можно скачать с https://www.curseforge.com/wow/addons/profession-master.",
            ...
            ["CommandsPurge"] = "/pm purge [all | own | <имя игрока>] - Удалить все данные, данные о себе или данные определенного игрока",
            ["CommandsPurgeRow1"] = "Доступные команды удаления:",
            ["CommandsPurgeRow2"] = "/pm purge all - Удалить все данные",
            ["CommandsPurgeRow3"] = "/pm purge own - Удалить данные о себе",
            ["CommandsPurgeRow4"] = "/pm purge <имя игрока> - Удалить данные определенного игрока",

            -- welcome
            ["WelcomeTitle"] = addon.name .. " - Добро пожаловать",
            ["WelcomeDescription"] = addon.name .. " отображает ваши профессии и профессии всех членов гильдии, использующих " .. addon.name .. ", в едином обзоре.\n\n" ..
                "Используйте кнопку на миникарте или команду чата /pm, чтобы показать или скрыть соответствующие окна.\n\n" ..
                "|cffd4af37Откройте окна профессий сейчас, чтобы поделиться своими профессиями.",
            ...
            ["ProfessionsViewEnchantment"] = "Чары",
            ...
            ["CharacterPurged"] = "Данные о %s были удалены"
        }
    };
end
